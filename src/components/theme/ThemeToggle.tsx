...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <label className={className ? `theme-toggle ${className}` : "theme-toggle"}>
      <input
        type="checkbox"
        checked={isDark}
      ...
      />
      <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        <defs>
          <filter id="theme-container" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <filter id="theme-sun-outer" x="-20%" y="-20%" width="140%" height="140%">
            <feGaussianBlur stdDeviation="1.5" />
          </filter>
          <filter id="theme-sun" x="-20%" y="-20%" width="140%" height="140%">
            <feGaussianBlur stdDeviation="1" />
          </filter>
          <filter id="theme-moon" x="-20%" y="-20%" width="140%" height="140%">
            <feGaussianBlur stdDeviation="1.5" />
          </filter>
          <filter id="theme-cloud" x="-20%" y="-20%" width="140%" height="140%">
            <feGaussianBlur stdDeviation="1" />
          </filter>
        </defs>
        <g transform="translate(3.5 3.5)">
          <g filter="url(#theme-container)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <rect fill="#83cbd8" transform="translate(3.5 3.5)" rx="17.5" height="35" width="60.667" id="container" />
          </g>
          <g transform="translate(2.333 2.333)" id="button">
            <g id="sun">
              <g filter="url(#theme-sun-outer)" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                <circle fill="#f8e664" transform="translate(5.83 5.83)" r="15.167" cy="15.167" cx="15.167" />
              </g>
              <g filter="url(#theme-sun)" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                <path
            ...
            <g id="moon">
              <g filter="url(#theme-moon)" transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
          ...
          <g filter="url(#theme-cloud)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
            <path
              fill="#fff"
